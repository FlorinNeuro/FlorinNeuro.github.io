...
While deep brain stimulation is a successful symptomatic treatment of Parkinson’s disease, its mechanisms are still not understood. To tackle this question, we have developed our own methods and adapted methods from different fields for use with electrophysiological data (Florin et al. 2010a; Kandemir et al. 2020; Sure et al. 2022). Employing Granger causality-based methods, we identified that the efficacy of deep brain stimulation of the subthalamic nucleus could, at least in part, result from a blockade of pathological afferent input (for example, Florin et al., 2016). Combining whole-head MEG recordings with STN LFP recordings, we implemented, for the first time, the neural event-triggered (NET) approach for MEG. The direct analysis of the interaction between STN activity and the cortex revealed the emergence of dynamic cortical networks associated with STN beta-bursts in PD (Sure et al., 2022), indicating the relevance of beta bursts for information processing.
